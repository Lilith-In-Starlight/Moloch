...
#	register_item(3, "egg", "Magic Egg", "If it hatches, it will summon a surprise", preload("res://Sprites/Items/Egg.png"))
	...
	register_behavior_mod("bouncy", "Bouncy Spell", "The next spell will be bouncy", preload("res://Sprites/Spells/Modifiers/Bouncy.png"))
	register_behavior_mod("ghost", "Ghostly", "The next spell will pass through walls", preload("res://Sprites/Spells/Modifiers/ghost.png"))
